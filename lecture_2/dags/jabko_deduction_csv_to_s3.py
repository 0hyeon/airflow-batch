...
dag = DAG(
    'jabko_process_and_upload_deduction_to_s3_with_hook',
...
def upload_to_s3_with_hook(**context):
    ...
    local_file_path = '/opt/airflow/data/final_attachment.csv'
...
trigger_processing = TriggerDagRunOperator(
    ...
    trigger_dag_id='jabko_iceberg_to_s3_emr',  # 이 DAG ID로 호출
    conf={
